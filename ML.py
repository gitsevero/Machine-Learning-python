...
while 1:
    try:  # um erro ocorre se não encontrar nada na janela, pois não
        ...
        cv2.rectangle(
            frame, (100, 100), (300, 300), (0, 255, 0), 0
        )  # leitura da máscara
        ...
        if l == 1:
            if areacnt < 2000:  # significa que não existe objeto na região
                ...
                if arearatio < 12 and not executado:
                    ...
                    cv2.putText(
                        frame, "", (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA
                    )
                    # os.system("start Arduino IDE.exe")

                else:
                    cv2.putText(
                        frame, "1 = Word", (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA
                    )
            ...
            cv2.putText(
                frame, "2 = Excel", (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA
            )
